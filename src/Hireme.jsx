...
const HireMe = ({ isOpen, onClose }) => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_st3rxcf",      // Replace with your EmailJS service ID
        "template_w7pyjdg",     // Replace with your EmailJS template ID
        formRef.current,
        "j2kluwE3xwjaaAAmx"     // Replace with your EmailJS public key
      )
      .then(
        (result) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
      <div className="bg-[#1f1f1f] text-white p-8 rounded-xl max-w-xl w-full relative">
        {/* Close Button */}
        <button
          onClick={(e) => {
            e.stopPropagation();
